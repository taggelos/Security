...
if (!isset($doit) or $doit != "yes") {
  ...
  $tool_content .= "
	...
	<ul class='listBullet'>
	<li>$langYes: ";
  $tool_content .=  "<form action='".htmlspecialchars($_SERVER[PHP_SELF])."?u=$uid&amp;cid=$cid&amp;doit=yes' class=mainpage  method=\"post\">";
      //.htmlspecialchars($u).

  $tool_content .= "<input type=\"submit\" value=\"$langUnregCours\">";
