...
if (!isset($a)) {
	...
	for ($j = 0; $j < mysql_num_rows($sql); $j++) {
		...
		//$tool_content .= "<a href='".htmlspecialchars($_SERVER[PHP_SELF])."?a=2&c=".$logs['id']."'>";

		$tool_content .=  "<form action='".htmlspecialchars($_SERVER[PHP_SELF])."?a=2&c=".$logs['id']."' method=\"post\">";
		//.htmlspecialchars($u).
		...
		//$tool_content .="<img src='../../images/delete.gif' border='0' title='$langDelete'></img></a>&nbsp;&nbsp;";
		$tool_content .="<a href='".htmlspecialchars($_SERVER[PHP_SELF])."?a=3&c=".$logs['id']."'>
